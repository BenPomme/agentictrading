...
FACTORY_AGENT_OPENAI_MODEL_HARD: str = os.getenv("FACTORY_AGENT_OPENAI_MODEL_HARD", "gpt-4.1")
FACTORY_AGENT_OPENAI_MODEL_FRONTIER: str = os.getenv("FACTORY_AGENT_OPENAI_MODEL_FRONTIER", "o4-mini")
FACTORY_AGENT_OPENAI_MODEL_DEEP: str = os.getenv("FACTORY_AGENT_OPENAI_MODEL_DEEP", "o3")
