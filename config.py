...
FACTORY_DATA_REFRESH_AUTOSTART_ENABLED: bool = (
    os.getenv("FACTORY_DATA_REFRESH_AUTOSTART_ENABLED", "true").lower() == "true"
)
FACTORY_DASHBOARD_AUTOSTART_ENABLED: bool = (
    os.getenv("FACTORY_DASHBOARD_AUTOSTART_ENABLED", "true").lower() == "true"
)
FACTORY_DASHBOARD_PORT: int = int(os.getenv("FACTORY_DASHBOARD_PORT", "8787"))
...
FACTORY_RUNTIME_MAX_ACTIVE_PAPER_LANES_PER_FAMILY: int = int(
    os.getenv("FACTORY_RUNTIME_MAX_ACTIVE_PAPER_LANES_PER_FAMILY", "1")
)
